...
var componentHandler = function () {
    "use strict";
    function e(e, t) {
        for (var s = 0; s < _.length; s++)if (_[s].className === e)return void 0 !== t && (_[s] = t), _[s];
        return !1
    }

    function t(i, n) {
        if (void 0 === i && void 0 === n)for (var a = 0; a < _.length; a++)t(_[a].className, _[a].cssClass); else {
            if (void 0 === n) {
                var l = e(i);
                l && (n = l.cssClass)
            }
    ...
    function r(e) {
        if (e && e[c].classConstructor.prototype.hasOwnProperty(h)) {
            ...
            var t = d.indexOf(e);
            d.splice(t, 1);
            var s = e.element_.dataset.upgraded.split(","), i = s.indexOf(e[c].classAsString);
    ...
    var _ = [], d = [], h = "mdlDowngrade_", c = "mdlComponentConfigInternal_";
    return {
        upgradeDom: t,
        upgradeElement: s,
...
window.addEventListener("load", function () {
    ...
    if (/iP(ad|hone|od).*OS 6/.test(window.navigator.userAgent) || !window.requestAnimationFrame || !window.cancelAnimationFrame) {
        ...
        window.requestAnimationFrame = function (e) {
            var t = Date.now(), s = Math.max(i + 16, t);
...
}), MaterialCheckbox.prototype.Constant_ = {TINY_TIMEOUT: .001}, MaterialCheckbox.prototype.CssClasses_ = {
...
}), MaterialIconToggle.prototype.Constant_ = {TINY_TIMEOUT: .001}, MaterialIconToggle.prototype.CssClasses_ = {
    ...
    if (this.element_) {
        ...
        var s = this.element_.getAttribute("for"), i = null;
        ...
        if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT))for (this.element_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS), a = 0; a < n.length; a++) {
            var l = n[a], r = document.createElement("span");
    ...
    if (this.element_ && this.container_ && this.outline_) {
        ...
        var s = this.element_.getBoundingClientRect().height, i = this.element_.getBoundingClientRect().width;
...
}), MaterialProgress.prototype.Constant_ = {}, MaterialProgress.prototype.CssClasses_ = {INDETERMINATE_CLASS: "mdl-progress__indeterminate"}, MaterialProgress.prototype.setProgress = function (e) {
    "use strict";
...
}), MaterialRadio.prototype.Constant_ = {TINY_TIMEOUT: .001}, MaterialRadio.prototype.CssClasses_ = {
    IS_FOCUSED: "is-focused",
    IS_DISABLED: "is-disabled",
    IS_CHECKED: "is-checked",
    IS_UPGRADED: "is-upgraded",
...
}), MaterialSpinner.prototype.Constant_ = {MDL_SPINNER_LAYER_COUNT: 4}, MaterialSpinner.prototype.CssClasses_ = {
...
}), MaterialSwitch.prototype.Constant_ = {TINY_TIMEOUT: .001}, MaterialSwitch.prototype.CssClasses_ = {
...
}),MaterialTooltip.prototype.Constant_ = {},MaterialTooltip.prototype.CssClasses_ = {IS_ACTIVE: "is-active"},MaterialTooltip.prototype.handleMouseEnter_ = function (e) {
    "use strict";
    e.stopPropagation();
    ...
    "use strict";
    if (this.element_) {
        var e = this.element_.querySelector("th"), t = this.element_.querySelector("tbody").querySelectorAll("tr");
        if (this.element_.classList.contains(this.CssClasses_.SELECTABLE)) {
            var s = document.createElement("th"), i = this.createCheckbox_(null, t);
            s.appendChild(i), e.parentElement.insertBefore(s, e);
            for (var n = 0; n < t.length; n++) {
                var a = t[n].querySelector("td");
                if (a) {
                    var l = document.createElement("td"), r = this.createCheckbox_(t[n]);
    ...
    if (this.rippleElement_.classList.add(this.CssClasses_.IS_VISIBLE), "mousedown" === e.type && this.ignoringMouseDown_)this.ignoringMouseDown_ = !1; else {
        ...
        if (0 === e.clientX && 0 === e.clientY)i = Math.round(a.width / 2), n = Math.round(a.height / 2); else {
            var l = e.clientX ? e.clientX : e.touches[0].clientX, r = e.clientY ? e.clientY : e.touches[0].clientY;
